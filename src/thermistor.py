...
tolerance = 250     # to keep from being jittery we'll only record a change
                    # when the temperature has changed a significant amount
                    # on a 16-bit ADC
...
#
        ...
        tempF = celcius_to_fahrenheit(tempC)
        print ('ADC Value : %d, Voltage : %.2f,Temperature : %.2f'%(value,voltage,tempF))
        time.sleep(0.01)
#
#
##########
